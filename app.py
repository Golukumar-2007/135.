...
def save():
    ...
    data = open('C:/Users/Nag/Desktop/Bhakti Coding/CP(coding)/PYTHON(projects)/Project 135/static/assets/datafiles/updated_product_dataset.csv' , 'a')

    # Log the data in the file
    data.write(data_entry + '/n')
